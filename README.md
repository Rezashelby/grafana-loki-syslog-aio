...
This project is based on the [grafana-loki-syslog-aio](https://github.com/lux4rd0/grafana-loki-syslog-aio) repository, with modifications made to enhance functionality.
...
This project is licensed under the **GNU Affero General Public License (AGPL) v3**. You are free to use, modify, and distribute this software as long as any modifications are shared under the same license.

For more information, see the full [AGPL-3.0 license](https://www.gnu.org/licenses/agpl-3.0.html).
